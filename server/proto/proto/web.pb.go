...
var file_web_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_web_proto_goTypes = []interface{}{
	...
	(AccountType)(0),         // 2: proto.AccountType
	(ErrorCode)(0),           // 3: proto.ErrorCode
}
var file_web_proto_depIdxs = []int32{
	2, // 0: proto.AccountLoginReq.partition:type_name -> proto.AccountType
	3, // 1: proto.AccountLoginResp.code:type_name -> proto.ErrorCode
